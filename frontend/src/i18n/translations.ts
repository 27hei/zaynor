...
export const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'phoneMockup.previewLabel': 'Preview of the Zaynor app',
    'phoneMockup.pauseMotion': 'Pause preview motion',
    'phoneMockup.resumeMotion': 'Resume preview motion',
    'phoneMockup.stateSearch': 'Searching for the best price',
    'phoneMockup.stateFound': 'Found 12 trusted offers',
    'phoneMockup.stateSave': 'Save SAR 700 today',
    'phoneMockup.priceAlert': 'Price dropped just now',
    'phoneMockup.guaranteeWe': 'We guarantee you',
    'phoneMockup.guaranteeBest': 'the best prices',
    'phoneMockup.guaranteeFrom': 'from trusted stores',

    'testimonials.kicker': 'Trusted by thousands of shoppers',
    'testimonials.titlePrefix': 'What our customers say about',
    'testimonials.titleSuffix': '?',
    'testimonials.subtitle': 'Real experiences from people who shop smart every day.',
    'testimonials.ratingLabel': '5 out of 5 stars',
    'currency.sar': 'SAR',
    ...
    'categories.previous': 'Previous category',
  ...
  ar: {
    ...
    'phoneMockup.previewLabel': 'معاينة لتطبيق زينور',
    'phoneMockup.pauseMotion': 'اضغط لإيقاف الحركة',
    'phoneMockup.resumeMotion': 'اضغط لتشغيل الحركة',
    'phoneMockup.stateSearch': 'جاري البحث عن أفضل سعر',
    'phoneMockup.stateFound': 'وجدنا 12 عرضًا موثوقًا',
    'phoneMockup.stateSave': 'وفّر 700 ر.س اليوم',
    'phoneMockup.priceAlert': 'انخفض السعر الآن',
    'phoneMockup.guaranteeWe': 'نضمن لك',
    'phoneMockup.guaranteeBest': 'أفضل الأسعار',
    'phoneMockup.guaranteeFrom': 'من متاجر موثوقة',

    'testimonials.kicker': 'ثقة آلاف المتسوقين',
    'testimonials.titlePrefix': 'ماذا يقول عملاؤنا عن',
    'testimonials.titleSuffix': '؟',
    'testimonials.subtitle': 'تجارب حقيقية من مستخدمين يتسوّقون بذكاء كل يوم.',
    'testimonials.ratingLabel': '5 من 5 نجوم',
    'currency.sar': 'ر.س',
    ...
    'results.listingsCount': '{count} عروض',
    'results.prevPage': 'السابق',
    'results.nextPage': 'التالي',
    'results.pageOf': 'صفحة {page} من {totalPages}',
    ...
    'categories.previous': 'الفئة السابقة',
